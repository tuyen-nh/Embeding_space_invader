...
void Screen2View::handleTickEvent()
{
    ...
    // ======================================================
        // 4. SỬA LỖI: DI CHUYỂN CỤM TRÁI TIM DỰA TRÊN BIÊN CỦA ENEMY CÒN SỐNG (FIX TREO MÀN HÌNH)
        // ======================================================
...
//        // ======================================================
//        // 4. KÍCH HOẠT BẮN ĐẠN NGẪU NHIÊN CỦA ENEMY (Giữ nguyên)
//        // ======================================================
    // 5. CỨ 1.5 GIÂY LÀ CHỌN ENEMY BẮN TIẾP (KHÔNG ĐỢI ĐẠN CŨ RƠI XUỐNG)
        // ------------------------------------------------------
        ...
        else
        {
            ...
            // cứ hết 1.5 giây là phải reset bộ đếm để tính lượt tiếp theo
            enemyShootTimer = 50;
        }
        	...
        	int pH = plane.getHeight();
        		...
        		for (int b = 0; b < MAX_ENEMY_BULLETS; b++)
        		{
        			if (enemyBullets[b] != nullptr && enemyBullets[b]->isVisible())
        			{
        				...
        				enemyBullets[b]->setY(enemyBullets[b]->getY() + 1); // Đạn rơi xuống
